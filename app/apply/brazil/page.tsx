...
import BrazilApplicationForm from "@/components/BrazilApplicationForm";

export const metadata: Metadata = {
  title: "Solicitar Empréstimo — Apply (Brazil)",
  description:
    "Solicite um empréstimo Easy Loan Approval em Reais. / Apply for a Easy Loan Approval loan in Brazilian Reais.",
};

export default function ApplyBrazilPage() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-sun-soft/50">
      ...
      <div className="relative mx-auto max-w-2xl px-4 pb-28 pt-4 sm:px-6">
        ...
        <h1 className="font-display mt-4 text-4xl font-bold tracking-tight text-ink">
          Solicite um empréstimo
          <span className="block text-2xl text-slate-500">Apply for a loan</span>
        </h1>
        <p className="mt-2 text-slate-600">
          Conte um pouco sobre você. Leva cerca de dois minutos. / Tell us a
          little about yourself. It takes about two minutes.
        </p>
