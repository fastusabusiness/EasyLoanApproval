...
import MexicoApplicationForm from "@/components/MexicoApplicationForm";

export const metadata: Metadata = {
  title: "Solicitar Préstamo — Apply (Mexico)",
  description:
    "Solicita un préstamo de Easy Loan Approval en pesos mexicanos. / Apply for a Easy Loan Approval loan in Mexican Pesos.",
};

export default function ApplyMexicoPage() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-sun-soft/50">
      ...
      <div className="relative mx-auto max-w-2xl px-4 pb-28 pt-4 sm:px-6">
        ...
        <p className="mt-2 text-slate-600">
          Cuéntanos un poco sobre ti. Toma unos dos minutos. / Tell us a little
          about yourself. It takes about two minutes.
        </p>
