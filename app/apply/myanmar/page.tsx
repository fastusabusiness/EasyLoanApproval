...
import MyanmarApplicationForm from "@/components/MyanmarApplicationForm";

export const metadata: Metadata = {
  title: "Apply — Myanmar",
  description: "Apply for a Easy Loan Approval loan in Myanmar Kyats.",
};

export default function ApplyMyanmarPage() {
  return (
