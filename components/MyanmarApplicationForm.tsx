...
// Standalone form for Myanmar applicants — deliberately separate from
...
// market: "MM"; lib/validation.ts branches on that to apply the right rules.
// English only (no Burmese translation available).
...
const QUICK_AMOUNTS = ["500,000", "1,000,000", "2,000,000", "5,000,000"];
...
export default function MyanmarApplicationForm() {
  ...
  useEffect(() => {
    ...
    if (n > 0 && n <= 5_000_000_000) {
      setForm((f) => (f.amount ? f : { ...f, amount: n.toLocaleString("en-US") }));
    }
  }, []);
            ...
            <div>
              ...
              {iconField(
                ...
                <input
                  ...
                  placeholder="123 Pyay Road, Yangon"
                  value={form.address}
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              >
                ...
                {EDUCATION_LEVELS_MM.map((level) => (
                  <option key={level} value={level}>
                    {EDUCATION_LABELS_MM[level]}
                  </option>
                ))}
              </select>
        ...
        <div key="step-1" className="animate-step-in space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              name="purposeDetail"
              rows={3}
              placeholder="Tell us a bit about your loan purpose…"
      ...
      {step === 2 && (
        <div key="step-2" className="animate-step-in space-y-5">
          ...
          <section className="rounded-2xl border-2 border-slate-100 px-5 py-4">
            ...
            <dl className="mt-1 divide-y divide-slate-100">
              <ReviewRow label="Amount" value={`K ${form.amount}`} />
